...
(function(factory) {
    ...
    if (typeof define != "undefined" && define.amd) define("jsyg-fulleditor",["jsyg","jsyg-editor","jsyg-texteditor","jsyg-zoomandpan","jsyg-pencil","jsyg-shapedrawer","jquery-hotkeys","jsyg-fetch"],factory);
    else if (typeof JSYG != "undefined") {
        
        var deps = ["Editor","TextEditor","ZoomAndPan","Pencil","ShapeDrawer","fetch"];
...
})(function(JSYG,Editor,TextEditor,ZoomAndPan,Pencil,ShapeDrawer) {
    ...
    FullEditor.prototype.enableShapeDrawer = function(modele) {
        ...
        function onmousedown(e) {
            ...
            var shape = new JSYG(modele).clone().appendTo(doc);
